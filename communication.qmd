...
![](images/email_example.png){width=60% fig-align="center" fig-alt="Screenshot of example email following guidance, with detailed subject line, formal greeting, direct descriptive text with hyperlinks and specific requests with clear deadlines." .lightbox}
