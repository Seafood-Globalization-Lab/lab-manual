...
output - Write out all cleaned versions of data (make sure the file name
differs from the raw data file name to avoid overwriting and confusion)
and analysis output here

figures - Write out all figures here. You may initially want to use
...
scripts or R - Save all R scripts here. If the project will be set up as
...
8. GitHub
    ...
    e. Do not push up non-analysis folders (e.g., "literature", "ms", "archive" etc.). Instead add to .gitignore 
