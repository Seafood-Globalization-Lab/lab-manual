...
Some people find the following annotated abstract example from *Nature* as a helpful guide: ![Nature annotated abstract](images/Nature-com_Abstract_Summary_writing_no_link_showing.jpeg)!{width="300px", fig-alt="Annotated abstract from Nature publishing that provides an example abstract strcuture beginning with 1-2 basic introduction sentences, followed by 2-3 more detailed background sentences, 1 general problem sentence, 1 main results sentence, 2-3 sentences explaining the results, 1-2 sentences that place results in the general context, and 2-3 sentences of broader context."}
...
To ensure that data creators and code developers are properly credited, it is important to make sure these are fully referenced. The R [grateful](https://cran.r-project.org/web/packages/grateful/index.html) package is a helpful tool to cite all packages and version used in a project.
